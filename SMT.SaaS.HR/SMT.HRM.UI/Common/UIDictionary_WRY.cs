...
namespace SMT.HRM.UI
{
    public partial class UIDictionary
    {
        private static void GetUIDictionary_WRY()
        {
            ...
            dicts.Add(new KeyValuePair<Type, List<string>>(typeof(EmployeeForm), new List<string> { "CHECKSTATE", "SEX", "NATION", "BLOODTYPE", "IDTYPE", "SECONDLANGUAGE", "SECONDLANGUAGEDEGREE", "EMPLOYEESTATE", "PROFESSIONALTITLE", "TOPEDUCATION", "POLITICS", "MARRIAGE", "PROVINCE", "RESIDENCETYPE", "REGRESIDENCETYPE", "ATTENDANCETYPE", "CARDTYPE", "WORKDAYTYPE" }));
