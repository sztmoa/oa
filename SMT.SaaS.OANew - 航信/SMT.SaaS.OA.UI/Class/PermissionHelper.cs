...
namespace SMT.SaaS.OA.UI
{
    public class PermissionHelper
    {
        ...
        //        int permvalue = Convert.ToInt32(perm);
        //        var tmp = Common.CurrentConfig.CurrentUser.PermissionInfo.Where(p => p.EntityMenu.ENTITYCODE == "T_HR_COMPANY").ToList();
        ...
        ///// <param name="perm">权限类型</param>
        ///// <returns>权限范围</returns>
        //public static int GetPermissionValueToUI(string menuCode, Permissions perm)
        //{
        //    //return 1;
        //    // edit liujx  将rslt=0 改为rslt=-1 有集团的权限为0 ，为最大权限
        //    int rslt = -1;
