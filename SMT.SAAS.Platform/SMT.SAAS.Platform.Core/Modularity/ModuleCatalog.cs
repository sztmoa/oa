...
{
    /// <summary>
    /// <see cref="ModuleCatalog"/>包含应用程序使用到的模块信息。模块信息由 <see cref="ModuleInfo"/>类描述，
    /// 包含了模块名称，模块类型和位置。<br/>
    /// 并且还要验证<see cref="ModuleCatalog"/> 的合法性。这个意思是，它没有：
    /// <list>
    ///     <item>循环依赖</item>
    ///     <item>缺少依赖</item>
    ///     <item>
    ///         无效的依赖关系，such as a Module that's loaded at startup that depends on a module
    ///         that might need to be retrieved.
    ///     </item>
    /// </list>
    /// <see cref="ModuleCatalog"/>也可以作为更多目录的基类。<br/>
    /// 
    ...
    public class ModuleCatalog : IModuleCatalog
    {
        ...
        /// <summary>
        /// 初始化 <see cref="ModuleCatalog"/>的实例.<br/>
        ...
        /// <summary>
        /// 根据给定的<see cref="ModuleInfo"/>集合，初始化<see cref="ModuleCatalog"/>的实例。<br/>
        ...
        /// <summary>
        /// 获取<see cref="ModuleCatalog"/>的元素集合。
        /// 这个属性的主要作用是可以通过XAML添加 <see cref="ModuleInfoGroup"/>和<see cref="ModuleInfo"/>。<br/>
        ...
        /// <value>
        /// 目录的元素集合.<br/>
        /// The items in the catalog.</value>
        ...
        /// <summary>
        /// 获取 <see cref="ModuleCatalog"/>里面的所有<see cref="ModuleInfo"/>。
        /// 不管他是否是<see cref="ModuleInfoGroup"/>。<br/>
        /// 
        ...
        public virtual void Validate()
        {
            ...
            {
                //try catch add by ken 20130426
                SMT.SAAS.Main.CurrentContext.AppContext.SystemMessage("SMT.SAAS.Platform.Core.Modularity Validate()异常："+ex.ToString());
        ...
        protected static void ValidateDependencies(IEnumerable<ModuleInfo> modules)
        {
            ...
            foreach (ModuleInfo moduleInfo in modules)
            {
                try
                {
                    ...
                    {
                        string msg = moduleInfo.ModuleName + "的";
