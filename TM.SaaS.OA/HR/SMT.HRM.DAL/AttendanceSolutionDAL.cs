    ...
    public class AttendanceSolutionDAL : CommDal<T_HR_ATTENDANCESOLUTION>
    {
       ...
       /// </summary>
        ...
        public T_HR_ATTENDANCESOLUTION GetAttendanceSolutionByEmployeeIDAndDate(string strEmployeeID, DateTime dtStart, DateTime dtEnd)
        {
            ...
            var qs = from s in GetObjects().Include("T_HR_SCHEDULINGTEMPLATEMASTER")
                                           .Include("T_HR_ATTENDANCESOLUTIONASIGN")//周文斌添加，
                     //引用地方：AttendanceSolutionBLL.GetAttendenceSolutionByEmployeeIDAndStartDateAndEndDate
