...
{
    public class HanziZhuanPingYin
    {
        #region gb2312中的汉字编码
        //01-09区为特殊符号。 
        //16-55区为一级汉字，按拼音排序。 
        ...
        private static readonly string[][] _Allhz = new string[][]
        {
            ...
            new string[]{"Gan","赶干感敢竿甘肝柑杆赣秆旰酐矸疳泔苷擀绀橄澉淦尴坩个乹乾亁仠佄倝凎凲咁奸尲尶尷幹忓扞捍攼桿榦檊檊汵浛漧灨玕玵皯盰稈笴筸篢簳粓紺芉虷衦詌諴豃贑贛趕迀釬錎飦骭魐鰔鱤鳡鳱"},
            ...
            new string[]{"Gib","喼"},
            new string[]{"Go","嗰"},
            new string[]{"Gong","工公功共弓攻宫供恭拱贡躬巩汞龚龚肱觥珙蚣匑匔厷咣唝嗊塨宮幊廾愩慐拲杛杠栱渱熕碽篢糼紅羾虹蛩觵貢贑贛赣躳輁銾鞏髸魟龏龔"},
        ...
        public static string Convert(string str)
        {
            ...
            for (int i = 0; i < charary.Length; i++)
            {
              // bAry = ed.GetBytes(charary[i].ToString());
                bAry = System.Text.Encoding.GetEncoding("unicode").GetBytes(charary[i].ToString());
                if (bAry.Length == 1)
                {
