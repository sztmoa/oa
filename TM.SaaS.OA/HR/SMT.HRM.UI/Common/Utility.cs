    ...
    public class Utility
    {
        ...
        public static void CreateFormFromEngine(string FormID, string FormName, string FormType, string XmlParemeter)
        {
            ...
            try
            {
                ...
                if (CurrentAction == FormTypes.Audit || CurrentAction == FormTypes.Browse)
                {
                    if (FormName == "SMT.HRM.UI.Form.Salary.EmployeeBalancePostAddForm")
                    {
                        FormName = "SMT.HRM.UI.Form.Salary.EmployeeBalancePostDetailForm";
                    }
                }
