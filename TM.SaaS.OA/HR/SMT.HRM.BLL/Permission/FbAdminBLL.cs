...
namespace SMT.SaaS.Permission.BLL
{
    public class FbAdminBLL:BaseBll<T_SYS_ROLE>
    {
        ...
        private T_SYS_ROLEENTITYMENU AddRoleEntity(string SysDictEntityId, T_SYS_ROLE role)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(rolemenu.ROLEENTITYMENUID))
                {
                    ...
                    rolemenu.T_SYS_ENTITYMENUReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ENTITYMENU", "ENTITYMENUID", SysDictEntityId);
                    //rolemenu.T_SYS_ENTITYMENU.ENTITYMENUID = EntityParentID;
                    rolemenu.T_SYS_ROLEReference.EntityKey = new System.Data.EntityKey("TM_SaaS_OA_EFModelContext.T_SYS_ROLE", "ROLEID", role.ROLEID);
        ...
        /// <param name="sysUserID"></param>
        /// <returns></returns>
        public List<T_SYS_FBADMIN> getFbAdminList(string sysUserID)
        {
            List<T_SYS_FBADMIN> Users = null;
            try
            {
                var ents = from ent in dal.GetObjects<T_SYS_FBADMIN>()
                           where ent.SYSUSERID == sysUserID
            ...
            {
                Tracer.Debug("菜单FbAdminBLL-getFbAdminList" + System.DateTime.Now.ToString() + " " + ex.ToString());
