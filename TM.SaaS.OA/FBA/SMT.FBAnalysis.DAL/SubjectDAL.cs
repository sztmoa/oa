...
{
    public class SubjectDAL : CommDal<T_FB_SUBJECT>
    {
        public SubjectDAL()
        {
        }
        ...
        /// <summary>
        /// 获取指定条件的T_FB_SUBJECT信息
        /// </summary>        
        /// <param name="strFilter">查询语句</param>
        /// <param name="objArgs">查询参数集合</param>
        /// <returns>返回T_FB_SUBJECT信息</returns>
        public T_FB_SUBJECT GetSubjectRdByMultSearch(string strFilter, params object[] objArgs)
        {
            var q = from v in GetObjects()
                    select v;
        ...
        /// <param name="objArgs">查询参数集合</param>
        /// <returns>返回T_FB_SUBJECT信息</returns>
        public IQueryable<T_FB_SUBJECT> GetSubjectRdListByMultSearch(string strOrderBy, string strFilter, params object[] objArgs)
        {
            var q = from v in GetObjects()
                    select v;
        ...
        public IQueryable<T_FB_SUBJECT> GetAllSubject()
        {
            var q = from v in GetObjects()
                    select v;
