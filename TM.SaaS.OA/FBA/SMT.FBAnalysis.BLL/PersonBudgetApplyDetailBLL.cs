...
/*
 * 文件名：PersonBudgetApplyDetailBLL.cs
 * 作  用：T_FB_PERSONBUDGETAPPLYDETAIL 业务逻辑类
 * 创建人：吴鹏
...
{
    public class PersonBudgetApplyDetailBLL
    {
        public PersonBudgetApplyDetailBLL()
        { }
        ...
        /// <summary>
        /// 根据条件，获取T_FB_PERSONBUDGETAPPLYDETAIL信息
        /// </summary>
        ...
        /// <returns></returns>
        public static IQueryable<T_FB_PERSONBUDGETAPPLYDETAIL> GetAllPersonBudgetApplyDetailRdListByMultSearch(string strFilter, List<object> objArgs, string strSortKey)
        {
            PersonBudgetApplyDetailDAL dalPersonBudgetApplyDetail = new PersonBudgetApplyDetailDAL();
            ...
            var q = dalPersonBudgetApplyDetail.GetPersonBudgetApplyDetailRdListByMultSearch(strOrderBy, strFilter, objArgs.ToArray());
            return q;
        }

        /// <summary>
        /// 根据条件，获取T_FB_PERSONBUDGETAPPLYDETAIL信息,并进行分页
        /// </summary>
        ...
        /// <returns>T_FB_PERSONBUDGETAPPLYDETAIL信息</returns>
        public IQueryable<T_FB_PERSONBUDGETAPPLYDETAIL> GetPersonBudgetApplyDetailRdListByMultSearch(string strFilter, List<object> objArgs,
            string strSortKey, int pageIndex, int pageSize, ref int pageCount)
        {
            var q = GetAllPersonBudgetApplyDetailRdListByMultSearch(strFilter, objArgs, strSortKey);

            return Utility.Pager<T_FB_PERSONBUDGETAPPLYDETAIL>(q, pageIndex, pageSize, ref pageCount);
        }
