...
{
    public class V_MyEusurvey
    {
        public T_OA_REQUIREMASTER OAMaster;
        public T_OA_REQUIRE OARequire;
        public T_OA_REQUIREDETAIL OADetail;
        public T_OA_DISTRIBUTEUSER distrbuteuser;
        public IEnumerable<T_OA_REQUIRERESULT> OAResult;
