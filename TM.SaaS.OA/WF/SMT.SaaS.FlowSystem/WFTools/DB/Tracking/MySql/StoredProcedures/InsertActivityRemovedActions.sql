...
DROP PROCEDURE IF EXISTS InsertActivityRemovedActions $$
/*
 * Insert a batch of activity removed actions.
 */	
CREATE PROCEDURE InsertActivityRemovedActions
(
	...
	,IN p_REMOVED_ACTIVITY_ACTION_1 VARCHAR(2000)
	...
	,IN p_REMOVED_ACTIVITY_ACTION_2 VARCHAR(2000)
	...
	,IN p_REMOVED_ACTIVITY_ACTION_3 VARCHAR(2000)
	...
	,IN p_REMOVED_ACTIVITY_ACTION_4 VARCHAR(2000)
	...
	,IN p_REMOVED_ACTIVITY_ACTION_5 VARCHAR(2000)
	,IN p_ORDER_5 INT UNSIGNED
)
sproc:BEGIN
	-- parameter set 1
	CALL InsertActivityRemovedAction(p_WORKFLOW_INSTANCE_ID,
