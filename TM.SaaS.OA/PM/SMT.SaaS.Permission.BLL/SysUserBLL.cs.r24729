    ...
    public class SysUserBLL : BaseBll<T_SYS_USER>, ILookupEntity
    {
        ...
        public SMT.SaaS.Permission.DAL.V_UserLogin AddUserLoginHis(string UserName, string Pwd, string Ip)
        {
            try
            {
                ...
                if (ents.Count() > 0)
                {
                    ...
                    V_EMPLOYEEDETAIL EmployeDetail = personnelclient.GetEmployeeDetailViewByID(ent.EMPLOYEEID);
            ...
            try
            {
                using (CommDAL<T_SYS_USERLOGINRECORD> urdal = new CommDAL<T_SYS_USERLOGINRECORD>())
                {
                    ...
                    if (ents.Count() > 0)
                    {
                        ...
                        V_EMPLOYEEDETAIL EmployeDetail = personnelclient.GetEmployeePostBriefByEmployeeID(ents.FirstOrDefault().EMPLOYEEID);
        ...
        public List<V_SupperFbAdmin> GetSupperAdmins()
        {
            ...
            try
            {
                ...
                var companys = Orgclinet.GetCompanyAll("");
                //获取超级预算管理员信息
                ...
                foreach (var ent in ents)
                {
                    ...
                    SMT.SaaS.BLLCommonServices.OrganizationWS.T_HR_COMPANY  company =companys.Where(s=>s.COMPANYID == ent.CompanyID).FirstOrDefault();
                    if(company != null)
                    {
            ...
            {                
                ...
                if (entity.Count() > 0)
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        new System.Data.EntityKey("SMT_System_EFModelContext.T_SYS_USER", "SYSUSERID", entitys.SYSUSERID);
