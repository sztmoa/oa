...
namespace SMT.SaaS.Permission.UI
{
    ...
    //    {
    //    }
    //    public PermissionService.T_SYS_USER UserInfo { get; set; }
    //    public List<PermissionService.V_Permission> PermissionInfo { get; set; }
    ...
    //    public PersonnelWS.T_HR_POST CurrentLoginPost
    //    {
    //        get
    //        {
    //            if (currentLoginPost == null)
    //            {
    //                //if (EmployeeInfo != null && EmployeeInfo.T_HR_EMPLOYEE != null)
