                ...
                item.Entity.PropertyChanged += (senderDept, eDept) =>
                    {
                        ...
                        if (eDept.PropertyName == "TOTALBUDGETMONEY" || eDept.PropertyName == "PERSONBUDGETMONEY")
                        {
                            ...
                            DeptDetail.TOTALAll = DeptDetail.TOTALBUDGETMONEY.Add(DeptDetail.BEGINNINGBUDGETBALANCE).Value;
                        }
                        #endregion
                    };
                #endregion
                    ...
                    itemPerson.Entity.PropertyChanged += (senderPerson, ePerson) =>
                        {
                            ...
                            {
                                T_FB_PERSONBUDGETAPPLYDETAIL senderPersonDetail = senderPerson as T_FB_PERSONBUDGETAPPLYDETAIL;
                                //合计
                                senderPersonDetail.TOTALAll = senderPersonDetail.BUDGETMONEY.Add(senderPersonDetail.LIMITBUDGETMONEY).Value;
                                ...
                                var totalPerson = obPersonDetail.Sum(itemPersonDetail =>
                                    {
                                       ...
                                       pDetail.TOTALAll = pDetail.BUDGETMONEY.Add(pDetail.LIMITBUDGETMONEY).Value;
                                    });
