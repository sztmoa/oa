...
namespace SMT
{
    ...
    public sealed class SqlDataProvider
    {
        ...
        /// <returns></returns>
        public static int ExecuteSQL(string sql, params SqlParameter[] commandParameters)
        {
            return ExecuteNonQuery(ConnectionString, CommandType.Text, sql, commandParameters);
        }
      
        #endregion
        #region ExecuteSPName存储过程
        /// <summary>
        /// 执行存储过程(返回受影响的记录数)
        /// </summary>
        /// <param name="spName">存储过程名称</param>
        /// <param name="parameterValues">参数数组,如果没有参可以null</param>
        /// <returns></returns>
        public static int ExecuteSpName(string spName, params object[] parameterValues)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("连接字符串");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("存储过程名称");
            // 如果存在参数值
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                // 从探索存储过程参数(加载到缓存)并分配给存储过程参数数组.
                SqlParameter[] commandParameters = SqlDataProviderParameterCache.GetSpParameterSet(ConnectionString, spName);
                // 给存储过程参数赋值
        ...
        /// <summary>
        ///  执行指定存储过程命令,直接提供参数值,返回DataSet.此方法不提供访问存储过程输出参数和返回值.
        /// </summary>
        /// <param name="spName">存储过程名称</param>
        ...
        /// <summary>
        ///  执行指定存储过程命令,直接提供参数值,返回DataTable.此方法不提供访问存储过程输出参数和返回值.
        /// </summary>
        /// <param name="spName">存储过程名称</param>
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param>
        ...
        /// <summary>
        /// 执行指定SQL语句命令,返回DataSet.
        /// </summary>
        /// <param name="sql">SQL语句命令</param>
        /// <returns></returns>
        public static DataSet ExecuteDataset(string sql)
        {
            return ExecuteDataset(ConnectionString, CommandType.Text, sql, (SqlParameter[])null);
        }
        /// <summary>
        /// 执行指定SQL语句命令,返回DataSet.
        /// </summary>
        ...
        {
            return ExecuteDataset(ConnectionString, CommandType.Text, sql, commandParameters);
        }
        #endregion
        #endregion
        ...
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            if (commandText == null || commandText.Length == 0) throw new ArgumentNullException("存储过程名称或SQL语句");
        ...
        public static int ExecuteNonQuery(SqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlDataProviderParameterCache.GetSpParameterSet(connection, spName);
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlDataProviderParameterCache.GetSpParameterSet(transaction.Connection, spName);
        ...
        /// 枚举,标识数据库连接是由SqlDataProvider提供还是由调用者提供
        ...
        private enum SqlConnectionOwnership
        {
            ...
            /// <summary>由SqlDataProvider提供连接</summary>
        ...
        /// 如果是SqlDataProvider打开连接,当连接关闭DataReader也将关闭.
        ...
        /// <param>标识数据库连接对象是由调用者提供还是由SqlDataProvider提供</param>
        ...
        public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
        ...
        public static int ExecuteNonQueryTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
        ...
        public static int ExecuteNonQueryTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
        ...
        public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
        ...
        public static DataSet ExecuteDatasetTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
        ...
        public static SqlDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteReader(connection, CommandType.StoredProcedure, spName);
        ...
        public static SqlDataReader ExecuteReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
        ...
        public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
        ...
        public static object ExecuteScalarTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
        ...
        public static object ExecuteScalarTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlConnection connection, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
        ...
        public static XmlReader ExecuteXmlReaderTypedParams(SqlTransaction transaction, String spName, DataRow dataRow)
        {
            ...
            if (dataRow != null && dataRow.ItemArray.Length > 0)
            {
                ...
                return SqlDataProvider.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                return SqlDataProvider.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
    ...
    /// SqlDataProviderParameterCache提供缓存存储过程参数,并能够在运行时从存储过程中探索参数.

    /// </summary>

    public sealed class SqlDataProviderParameterCache
    {
        ...
        private SqlDataProviderParameterCache() { }
