...
namespace MSCL
{
    ...
    public abstract class SqlHelper
    {
        ...
        /// <summary>
        /// 执行存储过程,带参数IDbDataParameter[]
        /// </summary>
        /// <param name="storedProcName">存储过程名</param>
        /// <param name="parameters">存储过程参数</param>
        /// <returns>SqlDataReader</returns>
        public static SqlDataReader RunProcedure(string storedProcName, IDbDataParameter[] parameters)
        {
            SqlConnection connection = new SqlConnection(LocalSqlServer);
        ...
        /// <returns>DataSet</returns>
        public static DataSet RunProcedure(string storedProcName, IDbDataParameter[] parameters, string tableName)
        {
            using (SqlConnection connection = new SqlConnection(LocalSqlServer))
            {
        ...
        /// <param name="parameters">存储过程参数</param>  
        /// <returns>DataSet</returns>
        public static DataTable GetDataTableByRunProcedure(string storedProcName, IDbDataParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(LocalSqlServer))
            {
                DataSet dataSet = new DataSet();
        ...
        /// <param name="parameters">存储过程参数</param>  
        /// <returns>DataSet</returns>
        public static DataTable GetDataTableByRunProcedure(string connectionString, string storedProcName, IDbDataParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet dataSet = new DataSet();
