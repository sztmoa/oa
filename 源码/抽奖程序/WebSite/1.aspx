...
<head>
    ...
    <style>
       ...
       .sz_award li,.bj_award li{  float:left;color:#FFF1B4; text-align:center; width:49%;border-radius: 14px; margin:0 0 6px 2px; padding:2px 0;
...
<body>
<img src="images/page_back_award1.jpg" style="width:100%; position:absolute; z-index:-1;" id="back_img" />
