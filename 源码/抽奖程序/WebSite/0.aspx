...
to { -webkit-transform: skew(40deg) ; }
    ...
    <script type="text/javascript">
        var playing = true;
        var cur_lev = 0, cur_num = 1, open = false, batch = "0";  //当前奖项和奖票数目
        $(function () {
            //点击备选号
...
<img src="images/0.jpg" style="width:100%; position:absolute; z-index:-1;" id="back_img" />
    ...
    <div id="stage" style="width: 100%; height:100%; position: absolute; z-index: 9999;">  
        ...
        <img src="images/0_stage_left.jpg" width="50%" id="stage_left02" style=" position:absolute; left:0;top:0;" /> 
        <img src="images/0_stage_right.jpg" width="50%" id="stage_right02" style=" position:absolute; right:0;top:0;"/>
